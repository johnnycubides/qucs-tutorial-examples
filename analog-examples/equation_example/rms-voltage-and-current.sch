...
<Properties>
  <View=-81,-62,1552,995,0.962033,0,0>
  <Grid=10,10,1>
...
<Components>
  <Vac V1 1 100 210 18 -26 0 1 "170 V" 1 "60 Hz" 1 "0" 0 "0" 0 "0" 0 "0" 0>
  ...
  <.TR tran 1 470 120 0 70 0 0 "lin" 1 "0" 1 "17 ms" 1 "300" 0 "Trapezoidal" 0 "2" 0 "1 ns" 0 "1e-16" 0 "150" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "26.85" 0 "1e-3" 0 "1e-6" 0 "1" 0 "CroutLU" 0 "no" 0 "yes" 0 "0" 0>
...
<Diagrams>
  <Rect 822 861 682 387 3 #c0c0c0 1 00 1 0 0.005 0.017 1 -0.263996 0.2 0.263997 1 -1 1 1 315 0 225 0 0 0 "" "" "">
	<"ngspice/tran.i(vmultimetro)" #0000ff 2 3 0 0 0>
	  <Mkr 0.00422328 257 -376 3 0 0>
	<"ngspice/tran.i_rms" #ff0000 2 3 0 0 0>
	  <Mkr 0.00410957 73 -201 3 0 0>
  </Rect>
  <Rect 50 858 673 378 3 #c0c0c0 1 00 1 0 0.002 0.017 1 -218.992 50 218.999 1 -1 0.2 1 315 0 225 0 0 0 "" "" "">
	<"ngspice/tran.v(fuente)" #0000ff 2 3 0 0 0>
	  <Mkr 0.00416642 214 -406 3 0 0>
	<"ngspice/tran.v_rms" #ff0000 2 3 0 0 0>
	  <Mkr 0.00422328 77 -213 3 0 0>
  </Rect>
</Diagrams>
<Paintings>
